...
bool operator==(const ::turtlebot3_example::Turtlebot3Feedback_<ContainerAllocator1> & lhs, const ::turtlebot3_example::Turtlebot3Feedback_<ContainerAllocator2> & rhs)
{
